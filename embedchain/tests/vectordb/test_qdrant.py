...
class TestQdrantDB(unittest.TestCase):
    ...
    def test_initialize(self, qdrant_client_mock):
        ...
        self.assertEqual(db.collection_name, "embedchain-store-1024")
    ...
    def test_add(self, uuid_mock, qdrant_client_mock):
        ...
        qdrant_client_mock.return_value.upsert.assert_called_once_with(
            collection_name="embedchain-store-1024",
            points=Batch(
                ids=["123", "456"],
                payloads=[
                    {
    ...
    def test_count(self, qdrant_client_mock):
        ...
        db.count()
        qdrant_client_mock.return_value.get_collection.assert_called_once_with(collection_name="embedchain-store-1024")
